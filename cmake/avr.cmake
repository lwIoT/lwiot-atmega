...
if(NOT AVR_TOOLCHAIN_PATH)
	SET(AVR_TOOLCHAIN_PATH /opt/avr-toolchain)
endif()

SET(CMAKE_FIND_ROOT_PATH ${AVR_TOOLCHAIN_PATH})
message(STATUS "Toolchain path: ${CMAKE_FIND_ROOT_PATH}")

set(CMAKE_ASM_COMPILER "${AVR_TOOLCHAIN_PATH}/bin/avr-gcc${CMAKE_EXECUTABLE_SUFFIX}")
set(CMAKE_C_COMPILER "${AVR_TOOLCHAIN_PATH}/bin/avr-gcc${CMAKE_EXECUTABLE_SUFFIX}")
set(CMAKE_CXX_COMPILER "${AVR_TOOLCHAIN_PATH}/bin/avr-g++${CMAKE_EXECUTABLE_SUFFIX}")
...
set(PORT_INCLUDE_DIR
	${PROJECT_SOURCE_DIR}/atmega/include
)
else()
set(PORT_INCLUDE_DIR
